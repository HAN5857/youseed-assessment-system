...
export function chineseStandard3Questions(): QData[] {
  ...
  return [
    ...
    single("把陈述句改成感叹句。\n\n原句：这朵花真美丽。\n\n哪一个改写最正确？", ["这朵花真美丽啊！", "这朵花真美丽吗？", "这朵花美丽。"], "A", "GRAMMAR", 2),
    single("用「把」字改写句子。\n\n原句：我做完了功课。\n\n哪一个改写最正确？", ["功课把我做完了。", "我把功课做完了。", "我做把功课完了。"], "B", "GRAMMAR", 2),
    {
...
export function chineseStandard4Questions(): QData[] {
  ...
  return [
    ...
    },
    {
      ...
      prompt: "根据下面提供的资料，书写一段文字，说明多阅读课外书的好处。\n\n• 增加知识，开阔视野\n• 提高写作与表达能力\n• 培养专注力与耐心\n• 放松心情，带来快乐",
...
export function chineseStandard5Questions(): QData[] {
  ...
  return [
    ...
    single("修改病句。\n\n原句：通过这次活动，使我明白了团结的重要。\n\n哪一个修改最正确？", ["通过这次活动，使我团结的重要。", "这次活动使我明白了团结的重要。", "通过这次活动，我使明白团结的重要。"], "B", "GRAMMAR", 2),
    single("把陈述句改成反问句。\n\n原句：我们不能忘记老师的教导。\n\n哪一个改写最正确？", ["我们不能忘记老师的教导吗。", "我们怎么能忘记老师的教导呢？", "老师的教导不能忘记我们。"], "B", "GRAMMAR", 2),
    {
