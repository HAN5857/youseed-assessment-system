...
const betulSalah = (
  ...
  content: { options: opt(["Betul", "Salah"]), ...extra }, answer: { key: betul ? "A" : "B" },
});
...
export function bahasaMelayuStandard4Questions(): QData[] {
  ...
  return [
    ...
    single("GRAMMAR", "Pilih kata yang paling sesuai.\n\nMurid-murid ______ buku teks ke sekolah setiap hari.", ["bawa", "membawa", "dibawa", "terbawa"], "B", 1, { imageUrl: `${IMG}/grammar-buku-sekolah.jpg`, imageAlt: "murid-murid membawa buku teks ke sekolah" }),
    single("GRAMMAR", "Pilih kata yang paling sesuai.\n\nEncik Hafiz ______ dari Kuala Lumpur ke Johor Bahru semalam.", ["pergi", "tiba", "bertolak", "singgah"], "C", 1, { imageUrl: `${IMG}/grammar-bas.jpg`, imageAlt: "bas ekspres dalam perjalanan antara bandar" }),
    single("GRAMMAR", "Pilih kata yang paling sesuai.\n\n______ kamu tidak sihat, lebih baik kamu berehat di rumah hari ini.", ["Supaya", "Apabila", "Jika", "Walaupun"], "C", 1, { imageUrl: `${IMG}/grammar-sakit.jpg`, imageAlt: "kanak-kanak yang tidak sihat sedang berehat di rumah" }),
    single("GRAMMAR", "Pilih penjodoh bilangan yang sesuai.\n\nMurid-murid sedang menampalkan se______ poster yang cantik di sudut kesihatan kelas.", ["helai", "keping", "buah", "biji"], "B", 1, { imageUrl: `${IMG}/grammar-poster.jpg`, imageAlt: "murid-murid menampalkan poster kesihatan di kelas" }),
    single("GRAMMAR", "Pilih kata ganti nama yang betul.\n\nPuan Salmah seorang guru. ______ mengajar mata pelajaran Sains.", ["Dia", "Beliau", "Mereka", "Kami"], "B", 1, { imageUrl: `${IMG}/grammar-guru-sains.jpg`, imageAlt: "Puan Salmah sedang mengajar mata pelajaran Sains" }),
    single("VOCAB", "Pilih kata adjektif yang paling tepat.\n\nAyah memandu kereta agak ______ semasa hujan lebat demi keselamatan keluarganya.", ["deras", "cepat", "ligat", "perlahan"], "D", 1, { imageUrl: `${IMG}/grammar-hujan.jpg`, imageAlt: "ayah memandu kereta dengan berhati-hati ketika hujan lebat" }),
    ...
    { type: "READING", dimension: "GRAMMAR", score: 5,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-kelas-bersih.jpg`, passageImageAlt: "murid-murid membersihkan kelas dengan penyapu dan tong sampah",
        subs: [
    ...
    { type: "READING", dimension: "READING", score: 5,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-berkebun.jpg`, passageImageAlt: "keluarga Encik Rizal berkebun bersama-sama di belakang rumah",
        subs: [
    ...
    betulSalah("READING", "Berdasarkan petikan “Budaya Berkebun”, Betul atau Salah:\n\nKeluarga Encik Rizal berkebun pada setiap hari bekerja.", false, 1, { imageUrl: `${IMG}/reading-berkebun.jpg`, imageAlt: "keluarga Encik Rizal berkebun bersama-sama" }),
    betulSalah("READING", "Berdasarkan petikan “Budaya Berkebun”, Betul atau Salah:\n\nEncik Rizal berpendapat bahawa berkebun mengajar nilai-nilai yang baik.", true, 1, { imageUrl: `${IMG}/visual-nilai-berkebun.jpg`, imageAlt: "keluarga menikmati hasil kebun mereka" }),
    betulSalah("READING", "Berdasarkan petikan “Budaya Berkebun”, Betul atau Salah:\n\nAnak-anak kecil tidak dibenarkan berkebun bersama keluarga.", false, 1, { imageUrl: `${IMG}/reading-penyiram.jpg`, imageAlt: "seorang kanak-kanak membantu memegang penyiram" }),
    ...
    { type: "SHORT", dimension: "WRITING", score: 3,
      ...
      content: { minWords: 1, maxWords: 1000, countOnly: true, lang: "ms", imageUrl: `${IMG}/visual-nilai-berkebun.jpg`, imageAlt: "keluarga menunjukkan nilai ketika berkebun",
    ...
    { type: "SHORT", dimension: "WRITING", score: 4,
      ...
      content: { minWords: 1, maxWords: 1000, countOnly: true, lang: "ms", imageUrl: `${IMG}/writing-tanggungjawab.jpg`, imageAlt: "seorang murid menegur rakannya yang membuang sampah di taman sekolah" },
...
export function bahasaMelayuStandard5Questions(): QData[] {
  ...
  return [
    ...
    single("GRAMMAR", "Pilih jawapan yang paling tepat.\n\nCadangan itu ______ oleh semua ahli jawatankuasa dengan sebulat suara.", ["menyokong", "disokong", "tersokong", "menyokongkan"], "B", 1, { imageUrl: `${IMG}/grammar-jawatankuasa.jpg`, imageAlt: "semua ahli jawatankuasa menyokong cadangan dengan sebulat suara" }),
    single("GRAMMAR", "Pilih jawapan yang paling tepat.\n\nKerajaan ______ kemudahan awam di kawasan luar bandar bagi meningkatkan kualiti hidup penduduk.", ["dipertingkatkan", "mempertingkatkan", "pertingkatkan", "bertingkat"], "B", 1, { imageUrl: `${IMG}/grammar-kemudahan.jpg`, imageAlt: "kemudahan awam yang baik di kawasan luar bandar" }),
    single("GRAMMAR", "Pilih jawapan yang paling tepat.\n\nGuru itu memberikan ______ kepada murid yang menghadapi masalah.", ["menasihat", "nasihat", "dinasihati", "penasihat"], "B", 1, { imageUrl: `${IMG}/grammar-nasihat.jpg`, imageAlt: "guru memberikan nasihat kepada murid" }),
    single("GRAMMAR", "Pilih kata hubung yang betul.\n\nPelajar cemerlang itu berjaya melanjutkan pelajarannya ke universiti ______ keluarganya tidak berada.", ["kerana", "walaupun", "supaya", "apabila"], "B", 1, { imageUrl: `${IMG}/grammar-universiti.jpg`, imageAlt: "pelajar menerima tawaran universiti bersama keluarganya" }),
    single("GRAMMAR", "Pilih kata penguat yang betul.\n\nPemandangan di puncak bukit itu indah ______ pada waktu pagi.", ["amat", "terlalu", "sekali", "paling"], "C", 1, { imageUrl: `${IMG}/grammar-pemandangan.jpg`, imageAlt: "pemandangan indah dari puncak bukit pada waktu pagi" }),
    ...
    { type: "READING", dimension: "GRAMMAR", score: 5,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-gotong-royong.jpg`, passageImageAlt: "murid-murid bergotong-royong membersihkan kawasan sekolah",
        subs: [
    ...
    { type: "READING", dimension: "READING", score: 1,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-integriti.jpg`, passageImageAlt: "murid menjawab peperiksaan dengan jujur tanpa meniru",
        subs: [
    ...
    { type: "FILL", dimension: "READING", score: 1,
      ...
      content: { caseSensitive: false, imageUrl: `${IMG}/reading-integriti.jpg`, imageAlt: "murid menjawab peperiksaan dengan jujur" }, answer: { accepted: ["integriti"] } },
    // (b) SHORT
    { type: "SHORT", dimension: "READING", score: 1,
      ...
      content: { minWords: 1, maxWords: 1000, countOnly: true, lang: "ms", imageUrl: `${IMG}/reading-integriti.jpg`, imageAlt: "murid menunjukkan integriti dengan menjawab peperiksaan secara jujur" },
    ...
    { type: "FILL", dimension: "GRAMMAR", score: 1,
      ...
      content: { caseSensitive: false, imageUrl: `${IMG}/visual-pinjam-buku.jpg`, imageAlt: "dua murid membina kepercayaan dengan memulangkan buku yang dipinjam" }, answer: { accepted: ["membina"] } },
    ...
    { type: "SHORT", dimension: "WRITING", score: 4,
      ...
      content: { minWords: 1, maxWords: 1000, countOnly: true, lang: "ms", imageUrl: `${IMG}/writing-dompet.jpg`, imageAlt: "seorang murid membantu rakannya mencari dompet yang hilang di kantin" },
...
export function bahasaMelayuStandard6Questions(): QData[] {
  ...
  return [
    ...
    single("GRAMMAR", "Pilih jawapan yang paling tepat.\n\nPunca utama pencemaran sungai itu ______ pembuangan sisa kilang secara haram.", ["ialah", "adalah", "merupakannya", "yang"], "A", 1, { imageUrl: `${IMG}/grammar-pencemaran.jpg`, imageAlt: "sungai tercemar akibat pembuangan sisa kilang" }),
    single("GRAMMAR", "Pilih jawapan yang paling tepat.\n\n______ teknologi moden telah mengubah cara manusia berkomunikasi pada hari ini.", ["Membangunkan", "Dibangunkan", "Pembangunan", "Bangunan"], "C", 1, { imageUrl: `${IMG}/grammar-teknologi.jpg`, imageAlt: "teknologi moden menghubungkan manusia melalui telefon dan panggilan video" }),
    single("GRAMMAR", "Pilih kata ganda yang betul.\n\nSuasana di dalam dewan itu menjadi ______ apabila keputusan pertandingan diumumkan.", ["riuh-riuh", "riuh-rendah", "meriah-meriah", "riuh-riuhan"], "B", 1, { imageUrl: `${IMG}/grammar-dewan.jpg`, imageAlt: "suasana dewan sekolah ketika keputusan pertandingan diumumkan" }),
    ...
    ], "A", 1, { imageUrl: `${IMG}/grammar-projek.jpg`, imageAlt: "sekumpulan murid menyiapkan projek dengan jayanya" }),
    ...
    ], "B", 1, { imageUrl: `${IMG}/grammar-pasar.jpg`, imageAlt: "seorang murid selesai makan sebelum pergi ke pasar" }),
    ...
    ], "A", 1, { imageUrl: `${IMG}/grammar-rajin.jpg`, imageAlt: "murid-murid sekolah belajar dengan rajin" }),
    single("VOCAB", "Pilih simpulan bahasa yang betul.\n\nGuru itu tidak pernah ______ dalam melayan semua muridnya.", ["buah hati", "makan angin", "pilih kasih", "kaki ayam"], "C", 1, { imageUrl: `${IMG}/grammar-pilih-kasih.jpg`, imageAlt: "guru memberikan perhatian yang adil kepada semua murid" }),
    ...
    ], "D", 1, { imageUrl: `${IMG}/grammar-inovasi.jpg`, imageAlt: "murid mencipta alat muzik kompang yang inovatif" }),
    ...
    { type: "READING", dimension: "GRAMMAR", score: 5,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-kitar-semula.jpg`, passageImageAlt: "murid-murid mengumpulkan botol plastik, surat khabar dan tin untuk dikitar semula",
        subs: [
    ...
    { type: "READING", dimension: "READING", score: 3,
      ...
      content: {
        ...
        passageImage: `${IMG}/reading-ketupat.jpg`, passageImageAlt: "ketupat dihidangkan bersama rendang, lontong dan kuah kacang",
        subs: [
    ...
    betulSalah("READING", "Berdasarkan petikan “Ketupat”, Betul atau Salah:\n\nKetupat hanya digemari oleh masyarakat Melayu sahaja.", false, 1, { imageUrl: `${IMG}/reading-keluarga.jpg`, imageAlt: "keluarga pelbagai kaum menikmati ketupat bersama-sama" }),
    betulSalah("READING", "Berdasarkan petikan “Ketupat”, Betul atau Salah:\n\nKetupat dibungkus dengan anyaman daun kelapa atau daun pandan.", true, 1, { imageUrl: `${IMG}/reading-ketupat.jpg`, imageAlt: "ketupat dibungkus dengan anyaman daun" }),
    ...
    { type: "SHORT", dimension: "WRITING", score: 4,
      ...
      content: { minWords: 1, maxWords: 1000, countOnly: true, lang: "ms", imageUrl: `${IMG}/writing-kemalangan.jpg`, imageAlt: "seorang murid membantu budak lelaki yang terjatuh daripada basikal" },
