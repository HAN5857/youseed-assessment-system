    ...
    return (
      <div>
        ...
        <input
          ...
          className={isCJK ? "mandarin-fill-input" : "w-full rounded-xl border border-[#DDEFE4] bg-white px-5 py-4 text-lg font-medium text-[#1F2937] outline-none transition focus:border-[#18A65B] focus:ring-4 focus:ring-emerald-100 sm:text-xl"}
